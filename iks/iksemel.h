...
/*****  utilities  *****/
extern void *iks_malloc (size_t size);
extern void iks_free (void *ptr);
...
/*tree to char  char to tree fiie to tree*/
...
/*****  stream parser  *****/
//正常情况下，iksStreamHook应该返回 IKS_OK
typedef int (iksStreamHook)(void *user_data, iks *node);
iksparser *iks_stream_new (void *user_data,iksStreamHook *streamHook);
